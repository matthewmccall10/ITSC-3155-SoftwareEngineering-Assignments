...
def resource(resource: schemas.ResourceCreate, db: Session = Depends(get_db)):
...
@app.get("/order_details/{order_details_id}", response_model=schemas.OrderDetail, tags=["OrderDetails"])
